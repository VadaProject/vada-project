  ...
  <li> <label for="<?php echo $claimid; ?>"><?php
        while ($d = $disp->fetch_assoc()) {
            if ('supporting' == $resultFlagType) {
                ...
                if ('Testimony' == $d['supportMeans'] || 'Perception' == $d['supportMeans']) {
...
<li> <label style="background:#FFFFE0" for="<?php echo $claimid; ?>">
    ...
    while ($d = $disp->fetch_assoc()) {
        ...
        if (1 == $d['active']) { // echo "<img width='50' height='50' src='assets/img/check_mark.php'> <br>! This claim is uncontested. <br>";
        } else {
            echo "<img src='assets/img/alert.png'> <br>";
        }
