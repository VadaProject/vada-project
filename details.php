...
<main class="page-container">
    ...
    */
    ...
    <p><label>Support Means:</label>
        <?php echo $claim->supportMeans; ?>
    </p>
    <?php
    if ($claim->COS == 'claim') { ?>
                    ...
                    <form method="POST" id="myForm" action="insert.php">
                        ...
                        -->
                            ...
                            <select name="flagType" id="flagType" value="flagType">
                                <option value="" selected>Select...</option>
                                <option value="Unestablished Subject">Unestablished
                                    Subject</option>
                                <option value="Itself Unestablished">Itself
                                    Unestablished</option>
                                <option value="Hostile">Hostile</option>
                                <option value="Too Narrow">Too Narrow</option>
                                <option value="Too Broad (Counterexample)">Too Broad
                                    (Counterexample)</option>
                                <option value="Too Broad (Unestablished Universal)">Too
                                    Broad (Unestabilshed Universal)</option>
                            ...
                            <!-- //------------------------- -->
                        <div class="center">
                            <button onclick="setTimeout(myFunction, 5000)"
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" id="myForm" action="insert.php">
                        ...
                        <p style="color:#000000" ;>
                            ...
                            <select name="flagType" id="flagType" value="flagType">
                                <option value="" selected>Select...</option>
                                <option value="No Direct Familiarity">No direct
                                    familiarity</option>
